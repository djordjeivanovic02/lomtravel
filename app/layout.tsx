...
export default function RootLayout({
  ...
  return (
    <>
      <html lang="sr" data-lt-installed="true" className="overflow-x-hidden">
        <head>
          <link
